...
bubbles // Returns whether or not a specific event is a bubbling event // https://www.w3schools.com/jsref/event_bubbles.asp
cancelBubble // Sets or returns whether the event should propagate up the hierarchy or     not // https://www.w3schools.com/jsref/event_cancelbubble.asp
cancelable // Returns whether or not an event can have its default action prevented // https://www.w3schools.com/jsref/event_cancelable.asp
composed // Returns whether the event is composed or not // https://www.w3schools.com/jsref/
createEvent() // Creates a new event // https://www.w3schools.com/jsref/event_createevent.asp
composedPath() // Returns the event's path // https://www.w3schools.com/jsref/event_composedpath.asp
currentTarget // Returns the element whose event listeners triggered the event // https://www.w3schools.com/jsref/event_currenttarget.asp
defaultPrevented // Returns whether or not the preventDefault() method was called for  the event // https://www.w3schools.com/jsref/event_defaultprevented.asp
eventPhase // Returns which phase of the event flow is currently being evaluated // https://www.w3schools.com/jsref/event_eventphase.asp
isTrusted // Returns whether or not an event is trusted // https://www.w3schools.com/jsref/event_istrusted.asp
preventDefault() // Cancels the event if it is cancelable, meaning that the default  action that belongs to the event will not occur // https://www.w3schools.com/jsref/event_preventdefault.asp
stopImmediatePropagation() // Prevents other listeners of the same event from being called // https://www.w3schools.com/jsref/event_stopimmediatepropagation.asp
stopPropagation() // Prevents further propagation of an event during event flow // https://www.w3schools.com/jsref/event_stoppropagation.asp
target // Returns the element that triggered the event // https://www.w3schools.com/jsref/event_target.asp
timeStamp // Returns the time (in milliseconds relative to the epoch) at which  the event was created // https://www.w3schools.com/jsref/event_timestamp.asp
type // Returns the name of the event // https://www.w3schools.com/jsref/event_type.asp
